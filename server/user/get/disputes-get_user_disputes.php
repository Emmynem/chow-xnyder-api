<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN products ON orders.product_unique_id = products.unique_id WHERE disputes.user_unique_id=:user_unique_id AND disputes.status=:status ORDER BY disputes.added_date DESC";
