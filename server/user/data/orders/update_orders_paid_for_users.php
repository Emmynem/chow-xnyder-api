        ...
        if ($queryTracker->rowCount() > 0) {
          ...
          if (!is_array($order_unique_ids)) {
            ...
            foreach ($order_unique_ids as $key => $the_order_unique_id){
              ...
              $sqlQuantity = "SELECT quantity, coupon_unique_id, shipping_fee_unique_id, amount, shipping_fee, credit, service_charge, payment_method, vendor_unique_id, product_unique_id FROM orders WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND tracker_unique_id=:tracker_unique_id AND paid!=:paid";
              ...
              if ($queryQuantity->rowCount() > 0) {
                ...
                $vendor_unique_id = $the_quantity_details[8];
                $product_unique_id = $the_quantity_details[9];
                ...
                if ($queryCategory->rowCount() > 0) {
                  ...
                  if ($query3->rowCount() > 0) {
                    ...
                    $the_coupon_price = ($product_full_price * $the_coupon_percentage) / 100;
                    ...
                    if ($the_coupon_count != 0) {
                      ...
                      // $final_price = ($product_full_price + $the_shipping_fee_price) - $the_coupon_price;
                      ...
                      // $final_price = $product_full_price + $the_shipping_fee_price;
                      $final_price = $product_full_price;
