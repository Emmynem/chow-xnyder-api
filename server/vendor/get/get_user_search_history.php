<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      users.fullname as user_fullname, users.email as user_email FROM search_history LEFT JOIN users ON search_history.user_unique_id = users.unique_id WHERE search_history.user_unique_id=:user_unique_id ORDER BY CASE WHEN search_history.user_unique_id != 'Anonymous' THEN 0 ELSE 1 END, search_history.added_date DESC";
