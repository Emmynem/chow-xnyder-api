<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN products ON product_images.product_unique_id = products.unique_id WHERE product_images.unique_id=:unique_id AND product_images.vendor_unique_id=:vendor_unique_id AND product_images.product_unique_id=:product_unique_id ORDER BY products.added_date DESC";
