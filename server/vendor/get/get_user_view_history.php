<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      FROM view_history INNER JOIN users ON view_history.user_unique_id = users.unique_id LEFT JOIN products ON view_history.product_unique_id = products.unique_id LEFT JOIN vendors ON products.vendor_unique_id = vendors.unique_id INNER JOIN categories ON products.category_unique_id = categories.unique_id
      WHERE view_history.user_unique_id=:user_unique_id ORDER BY view_history.added_date DESC";
