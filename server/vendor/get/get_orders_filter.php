<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN vendors ON orders.vendor_unique_id = vendors.unique_id WHERE orders.vendor_unique_id=:vendor_unique_id AND (orders.added_date=:start_date OR orders.added_date >:start_date) AND (orders.added_date <:end_date OR orders.added_date=:end_date) ORDER BY orders.added_date DESC";
