<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $sql = "SELECT disputes.unique_id, disputes.order_unique_id, disputes.message, disputes.last_modified, disputes.status, users.fullname as user_fullname, users.email as user_email,
      ...
      LEFT JOIN products ON orders.product_unique_id = products.unique_id WHERE disputes.user_unique_id=:user_unique_id AND disputes.order_unique_id=:order_unique_id AND orders.vendor_unique_id=:vendor_unique_id ORDER BY disputes.added_date DESC";
