<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN vendors ON products.vendor_unique_id = vendors.unique_id WHERE favorites.user_unique_id=:user_unique_id AND products.vendor_unique_id=:vendor_unique_id ORDER BY favorites.added_date DESC";
      $query = $conn->prepare($sql);
      $query->bindParam(":user_unique_id", $vendor_unique_id);
