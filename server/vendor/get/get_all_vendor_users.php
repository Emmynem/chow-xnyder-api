<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      vendor_users_alt.fullname as added_fullname FROM vendor_users INNER JOIN vendor_users vendor_users_alt ON vendor_users.user_unique_id = vendor_users_alt.unique_id ORDER BY vendor_users.added_date DESC";
