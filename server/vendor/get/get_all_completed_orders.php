<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      orders_completed.shipping_fee_price, orders_completed.total_price, orders_completed.added_date FROM orders_completed LEFT JOIN vendors ON orders_completed.vendor_unique_id = vendors.unique_id WHERE orders_completed.vendor_unique_id=:vendor_unique_id ORDER BY orders_completed.added_date DESC";
