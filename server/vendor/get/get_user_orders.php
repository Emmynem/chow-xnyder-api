<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN vendors ON orders.vendor_unique_id = vendors.unique_id WHERE orders.user_unique_id=:user_unique_id AND orders.vendor_unique_id=:vendor_unique_id ORDER BY orders.added_date DESC";
