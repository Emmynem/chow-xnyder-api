<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN products ON shipping_fees.product_unique_id = products.unique_id INNER JOIN vendor_users ON shipping_fees.user_unique_id = vendor_users.unique_id
      WHERE shipping_fees.vendor_unique_id=:vendor_unique_id AND shipping_fees.product_unique_id=:product_unique_id ORDER BY shipping_fees.added_date DESC";
