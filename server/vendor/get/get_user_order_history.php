<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN products ON orders.product_unique_id = products.unique_id WHERE order_history.user_unique_id=:user_unique_id AND order_history.order_unique_id=:order_unique_id AND orders.vendor_unique_id=:vendor_unique_id ORDER BY order_history.added_date DESC";
