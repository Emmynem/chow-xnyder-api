<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      vendors.opening_hours, vendors.closing_hours, vendors.balance, vendors.service_charge, vendors.city, vendors.state, vendors.country, vendors.address, vendors.added_date, vendors.last_modified, vendors.access, vendors.subscription,
      vendors.status FROM vendors WHERE vendors.unique_id=:unique_id ORDER BY vendors.added_date DESC";
