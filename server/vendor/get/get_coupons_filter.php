<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN categories ON coupons.category_unique_id = categories.unique_id WHERE coupons.vendor_unique_id=:vendor_unique_id AND (coupons.added_date=:start_date OR coupons.added_date >:start_date) AND (coupons.added_date <:end_date OR coupons.added_date=:end_date) ORDER BY coupons.added_date DESC";
