<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $sql3 = "SELECT products.unique_id, products.name, products.stripped, products.description, products.duration, products.weight, products.stock, products.stock_remaining, products.price, products.sales_price, products.views, products.favorites, products.good_rating, products.bad_rating,
      ...
      LEFT JOIN menus ON products.menu_unique_id = menus.unique_id WHERE products.unique_id=:unique_id AND products.vendor_unique_id=:vendor_unique_id ORDER BY products.added_date ASC";
      ...
      if ($query3->rowCount() > 0) {
        ...
        foreach ($product_result as $key => $value) {
          ...
          $current_product['stock'] = $value['stock'];
          $current_product['stock_remaining'] = $value['stock_remaining'];
