<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN products ON orders.product_unique_id = products.unique_id WHERE disputes.user_unique_id=:user_unique_id AND orders.vendor_unique_id=:vendor_unique_id ORDER BY disputes.added_date DESC";
