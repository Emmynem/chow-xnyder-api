<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      LEFT JOIN categories ON coupons.category_unique_id = categories.unique_id WHERE coupons.vendor_unique_id=:vendor_unique_id ORDER BY coupons.added_date DESC";
