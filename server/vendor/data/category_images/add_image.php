    ...
    try {
      ...
      // if ($querySearchUser->rowCount() > 0) {
        ...
        if (in_array($user_unique_id,$authorized_users)) {
          ...
          $sql3 = "SELECT unique_id FROM category_images WHERE category_unique_id=:category_unique_id AND status=:status";
                              ...
                              if((isset($newFilename)) && ($newFilename != "Image already exist")){
                                ...
                                if(compressImage($sourcePath, $path, 60) == 1){
                                 $file = $path;
                                  ...
                                  $sql = "INSERT INTO category_images (unique_id, user_unique_id, category_unique_id, image, file, file_size, added_date, last_modified, status)
                                  VALUES (:unique_id, :user_unique_id, :category_unique_id, :image, :file, :file_size, :added_date, :last_modified, :status)";
