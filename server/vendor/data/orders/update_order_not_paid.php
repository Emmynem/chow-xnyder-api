<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $transaction_status = $functions->debt_nullified;
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($validation["error"] == true) {
          ...
          $sqlOrder = "SELECT delivery_status, user_unique_id, service_charge FROM orders WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND tracker_unique_id=:tracker_unique_id AND vendor_unique_id=:vendor_unique_id AND paid!=:paid AND status=:status";
          ...
          if ($queryOrder->rowCount() > 0) {
            ...
            $the_service_charge = (int)$the_order_details[2];
            ...
            if (strtolower($the_delivery_status) == strtolower($option)) {
              ...
              $sql2 = "UPDATE orders SET disputed=:disputed, delivery_status=:delivery_status, last_modified=:last_modified WHERE unique_id=:unique_id AND user_unique_id=:user_unique_id AND vendor_unique_id=:vendor_unique_id";
              ...
              if ($query2->rowCount() > 0) {
                ...
                if ($query->rowCount() > 0) {
                  ...
                  if ($query3->rowCount() > 0) {
                    ...
                    $details = $transaction_type." : ".$the_service_charge." Naira ".$transaction_status." on order(".$order_unique_id.") tracking id(".$tracker_unique_id.")";
                    ...
                    $query8->bindParam(":amount", $the_service_charge);
