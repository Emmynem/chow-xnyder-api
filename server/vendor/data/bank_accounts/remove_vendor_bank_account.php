  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $sql2 = "SELECT status FROM vendor_bank_accounts WHERE unique_id=:unique_id AND vendor_unique_id=:vendor_unique_id AND status=:status";
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql = "DELETE FROM vendor_bank_accounts WHERE unique_id=:unique_id AND vendor_unique_id=:vendor_unique_id";
          ...
          if ($query->rowCount() > 0) {
            ...
            $returnvalue->engineErrorMessage = "Not removed (vendor bank account)";
          }
