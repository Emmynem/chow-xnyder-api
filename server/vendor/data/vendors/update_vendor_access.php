<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $sqlSearchUser = "SELECT unique_id FROM management WHERE unique_id=:unique_id AND vendor_unique_id=:vendor_unique_id AND status=:status";
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "UPDATE vendor_users SET access=:access, last_modified=:last_modified WHERE unique_id=:unique_id";
          $query3 = $conn->prepare($sql3);
          $query3->bindParam(":access", $access);
          ...
          if ($query3->rowCount() > 0) {
            ...
            $sql = "UPDATE vendors SET access=:access, last_modified=:last_modified WHERE unique_id=:unique_id";
            ...
            $returnvalue = new genericClass();
            $returnvalue->engineError = 2;
            $returnvalue->engineErrorMessage = "Not edited (vendor users)";
          }
