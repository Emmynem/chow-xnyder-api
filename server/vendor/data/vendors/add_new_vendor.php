    ...
    try {
      ...
      if ($validation["error"] == true) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $query->bindParam(":access", $not_active);
          ...
          if ($query->rowCount() > 0) {
            ...
            $query4->bindParam(":subscription", $not_active);
            ...
            if ($query4->rowCount() > 0) {
              ...
              if ($query5->rowCount() > 0) {
                ...
                $sql6 = "INSERT INTO preferences (unique_id, user_unique_id, vendor_unique_id, last_modified)
                ...
                $query6->bindParam(":user_unique_id", $vendor_users_unique_id);
