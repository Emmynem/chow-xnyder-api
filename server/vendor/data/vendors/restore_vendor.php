    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "UPDATE vendor_users SET status=:status, last_modified=:last_modified WHERE unique_id=:unique_id";
          ...
          if ($query3->rowCount() > 0) {
            ...
            $sql = "UPDATE vendors SET status=:status, last_modified=:last_modified WHERE unique_id=:unique_id";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue->engineErrorMessage = "Not restored (vendor)";
            }
            ...
            $returnvalue = new genericClass();
            $returnvalue->engineError = 2;
            $returnvalue->engineErrorMessage = "Not restored (vendor users)";
          }
