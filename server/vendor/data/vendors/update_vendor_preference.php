<?php
  ...
  if ($connected) {
    ...
    try {
      ...
      $preference_allowed_values = $functions->preference_allowed_values;
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if (!in_array($preference,$preference_allowed_values)) {
          ...
          $sql = "UPDATE preferences SET $preference=:$preference, last_modified=:last_modified WHERE vendor_unique_id=:vendor_unique_id AND user_unique_id=:user_unique_id";
          ...
          if ($query->rowCount() > 0) {
            ...
            $returnvalue = new genericClass();
            $returnvalue->engineError = 2;
            $returnvalue->engineErrorMessage = "Not edited (vendor preference)";
          }
