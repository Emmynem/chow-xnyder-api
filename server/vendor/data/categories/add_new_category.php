        ...
        if (in_array($user_unique_id,$authorized_users)) {
          ...
          if ($validation["error"] == true) {
            ...
            if ($query2->rowCount() > 0) {
              ...
              $sql = "INSERT INTO categories (unique_id, user_unique_id, name, stripped, added_date, last_modified, status)
              VALUES (:unique_id, :user_unique_id, :name, :stripped, :added_date, :last_modified, :status)";
