    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        if ($query2->rowCount() > 0) {
          ...
          $sql3 = "DELETE FROM favorites WHERE product_unique_id=:product_unique_id";
          ...
          if ($query3->rowCount() > 0) {
            ...
            $sql4 = "DELETE FROM view_history WHERE product_unique_id=:product_unique_id";
            $query4 = $conn->prepare($sql4);
            $query4->bindParam(":product_unique_id", $unique_id);
            $query4->execute();

            if ($query4->rowCount() > 0) {

              $sql = "DELETE FROM products WHERE unique_id=:unique_id AND vendor_unique_id=:vendor_unique_id";
              ...
              if ($query->rowCount() > 0) {
                ...
                $returnvalue->engineErrorMessage = "Not removed (item)";
              }
