    ...
    try {
      ...
      // if ($querySearchUser->rowCount() > 0) {
        ...
        if (in_array($user_unique_id,$authorized_users)) {
          ...
          $sql4 = "SELECT bank FROM bank_accounts WHERE status=:status";
          ...
          if ($query4->rowCount() > 0 && $query4->rowCount() == 1) {
            ...
            if ($the_default_status == "Yes") {
              $sql2 = "SELECT default_status FROM bank_accounts WHERE unique_id=:unique_id AND status=:status";
              ...
              if ($query2->rowCount() > 0) {
                ...
                $sql = "UPDATE bank_accounts SET default_status=:default_status, last_modified=:last_modified WHERE unique_id=:unique_id";
                ...
                $sql3 = "UPDATE bank_accounts SET default_status=:default_status, last_modified=:last_modified WHERE unique_id!=:unique_id";
