      ...
      // if ($querySearchUser->rowCount() > 0) {
        ...
        if (in_array($user_unique_id,$authorized_users)) {
          ...
          if ($validation["error"] == true) {
            ...
            $sql2 = "SELECT bank FROM bank_accounts WHERE unique_id=:unique_id AND status=:status";
            ...
            if ($query2->rowCount() > 0) {
              ...
              $sql3 = "SELECT bank FROM bank_accounts WHERE unique_id!=:unique_id AND account_name=:account_name AND account_number=:account_number AND bank=:bank AND status=:status";
              ...
              if ($query3->rowCount() > 0) {
                ...
                $sql = "UPDATE bank_accounts SET account_name=:account_name, account_number=:account_number, bank=:bank, last_modified=:last_modified WHERE unique_id=:unique_id";
                ...
                if ($query->rowCount() > 0) {
                  ...
                  $returnvalue = new genericClass();
                  $returnvalue->engineError = 2;
                  $returnvalue->engineErrorMessage = "Not edited (company bank account)";
                }
