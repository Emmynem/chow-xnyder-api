  ...
  if ($connected) {
    ...
    try {
      ...
      if ($querySearchUser->rowCount() > 0) {
        ...
        $validation = $functions->update_user_vendor_role_validation($role);
        ...
        if ($validation["error"] == true) {
          ...
          if ($query2->rowCount() > 0) {
            ...
            $sql = "UPDATE vendor_users SET role=:role, last_modified=:last_modified WHERE unique_id=:unique_id AND vendor_unique_id=:vendor_unique_id";
            ...
            if ($query->rowCount() > 0) {
              ...
              $returnvalue = new genericClass();
              $returnvalue->engineError = 2;
              $returnvalue->engineErrorMessage = "Not edited (vendor user role)";
            }
            ...
            $returnvalue = new genericClass();
            $returnvalue->engineError = 2;
            $returnvalue->engineErrorMessage = "Vendor user to change role not found";
          }
